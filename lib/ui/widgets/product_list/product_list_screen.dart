...
class ProductListScreen extends StatelessWidget {
  ...
  const ProductListScreen({Key? key, required this.groupIndex}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    final List<Product> productListInGroup = _model.productService.loadProducts().where((element) => element.productGroup == groupIndex).toList();
    return Scaffold(
        appBar: AppBar(
          actions: [
            IconButton (
                  ...
                  child: Container(
                    ...
                    child: ListTile(
                        ...
                        trailing: IconButton(
                          ...
                          onPressed: () => _groupModel.addToCart(_productId, _price),
                        )
                    ),
                  ),
                );
